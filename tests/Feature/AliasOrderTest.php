...
test('title alias keeps canonical order', function () {
    ...
    expect($pipeline)->toBe('unicode|strip_html|strip_emoji|strip_newlines|trim|squish|lower|ucfirst');
...
test('text alias performs generic text cleanup', function () {
    ...
    expect($pipeline)->toBe('unicode|strip_html|strip_emoji|strip_newlines|trim|squish');
...
test('ascii alias applies ascii-only cleanup', function () {
    ...
    expect($pipeline)->toBe('unicode|strip_html|strip_emoji|strip_newlines|trim|squish|ascii|trim');
