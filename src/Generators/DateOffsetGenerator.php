 ...
 */
class DateOffsetGenerator implements GeneratorContract
{
    /**
     * Create a new date offset generator.
     *
    ...
    public function generate(string $field, object $model): Carbon
    {
        ...
        if (!$date) {
            throw new RuntimeException("DateOffsetGenerator: Invalid date modifier [{$this->modifier}]");
        }
