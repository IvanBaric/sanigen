 ...
 */
class UniqueStringGenerator implements GeneratorContract
{
    /**
    ...
    public function generate(string $field, object $model): string
    {
        ...
        if ($exists) {
            throw new RuntimeException("Unable to generate unique string for [$field] after {$this->maxAttempts} attempts.");
        }
